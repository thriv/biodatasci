...
10. Looking at that above plot, I'm interested in (a) what are those movies with the largest number of votes? and (b) what are those movies with at least 10,000 votes that have the worst scores?
...
What categories of majors make more money than others? Let's make a bosplot of median income by major category. Let's expand the limits to include 0 on the y-axis, and flip the coordinate system.
